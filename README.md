...
Tab:AddButton({
	Name = "Phantasm Hub 👻",
	Callback = function()
getgenv().ToggleKeybind = Enum.KeyCode.RightControl getgenv().FreeEmotesTab = true -- if you want free emotes turn this to true
...
Tab:AddButton({
	Name = "halloween special 🎃 (limited since 2023)",
	Callback = function()
